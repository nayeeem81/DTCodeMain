...
namespace FineArtsWebApp
{
    public class ProductMappingService : IProductMappingService
    {
        ...
        public Product MapProductViweModelToProductEntity(ProductViewModel productVM)
        {
            return new Product()
            {
                ProductName = productVM.ProductName,
                SearchTag = productVM.SearchTag.IsNullOrWhiteSpace() ? null : productVM.SearchTag,
        ...
        public void MapProductEntityToProductViewModelListModel(Product postEntity, ProductViewModel productViewModel)
        {
        ...
        public List<ProductImageFile> MapProductViweModelToProductFileEntity(ProductViewModel productFileVM)
        {
